...
public class SellerDAO {
		...
		public static SellerDTO addSeller(SellerDTO Seller) throws SQLException {
			...
			try {
				...
				pstmt.setInt(1, Seller.getProductNumber());
				pstmt.setString(2, Seller.getSellerName());
				pstmt.setString(3, Seller.getSellerAddress());
				pstmt.setString(4, Seller.getSellerPhone());
		...
		public static boolean deleteSeller(String sellerName) throws SQLException {
			Connection con = null;
			PreparedStatement pstmt = null;
			try {
				con = DBUtil.getConnection();
